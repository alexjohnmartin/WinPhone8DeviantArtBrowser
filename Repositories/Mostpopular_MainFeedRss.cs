...
namespace WPAppStudio.Repositories
{
    ...
    public class Mostpopular_MainFeedRss : IMostpopular_MainFeedRss 
    {
		...
		private const string RssUrl = "http://backend.deviantart.com/rss.xml?type=deviation&q=boost%3Apopular";

        /// <summary>
        /// Initializes a new instance of the <see cref="Mostpopular_MainFeedRss" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Mostpopular_MainFeedRss(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://backend.deviantart.com/rss.xml?type=deviation&q=boost%3Apopular), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("Mostpopular_MainFeedRss", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("Mostpopular_MainFeedRss");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://backend.deviantart.com/rss.xml?type=deviation&q=boost%3Apopular), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
