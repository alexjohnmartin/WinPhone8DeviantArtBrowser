...
namespace WPAppStudio.Repositories
{
    ...
    public class Latest_LatestRss : ILatest_LatestRss 
    {
		...
		private const string RssUrl = "http://backend.deviantart.com/rss.xml?type=deviation&q=sort%3Atime";

        /// <summary>
        /// Initializes a new instance of the <see cref="Latest_LatestRss" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Latest_LatestRss(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://backend.deviantart.com/rss.xml?type=deviation&q=sort%3Atime), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("Latest_LatestRss", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("Latest_LatestRss");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://backend.deviantart.com/rss.xml?type=deviation&q=sort%3Atime), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
