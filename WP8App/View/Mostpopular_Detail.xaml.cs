...
{
    /// <summary>
    /// Phone application page for Mostpopular_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Mostpopular_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Mostpopular_Detail and all its components.
        /// </summary>
        public Mostpopular_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaMostpopular_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaMostpopular_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaMostpopular_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaMostpopular_Detail(PanoramaMostpopular_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaMostpopular_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IMostpopular_MainFeedRss>();
				AddHomeAppBarButton();
				...
				((IViewModels.IMostpopular_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
        ...
        private void AddHomeAppBarButton()
        {
			...
			{ 
				new Ioc.Container().Resolve<IServices.INavigationService>().NavigateTo<IViewModels.IMostpopular_NewsViewModel>(); 
