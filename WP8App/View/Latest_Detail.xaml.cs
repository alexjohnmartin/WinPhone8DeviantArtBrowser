...
{
    /// <summary>
    /// Phone application page for Latest_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Latest_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Latest_Detail and all its components.
        /// </summary>
        public Latest_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaLatest_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaLatest_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaLatest_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaLatest_Detail(PanoramaLatest_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaLatest_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.ILatest_LatestRss>();
				AddHomeAppBarButton();
				...
				((IViewModels.ILatest_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
